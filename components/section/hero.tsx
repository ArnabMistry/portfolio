...
export default function Hero() {
  return (
    <>
      <div className="px-20 pt-11 flex items-center justify-between">
      ...
      <section className="pt-12 flex items-center">
        <div className="w-full px-10 md:px-20">
          <h1 className="text-white tracking-wide text-7xl md:text-[10vw] font-chunk leading-none">
            PRECISION
          </h1>
          <div className="flex justify-center my-6">
            <h2 className="text-7xl md:text-[12vw] font-alexbrush text-orange-700">
              and
            </h2>
          </div>
